...
export function setJobParams(rid, datasetId, sectionId, knnNum, numSpots, numCells, numRedundancy, cutoff, bandWidth) {
    return new Promise( (resolve, reject)=>{
        ...
        poolReadWrite.getConnection((err, connection)=>{
            ...
            connection.query(insertSql, [rid, datasetId, sectionId, knnNum, numSpots, numCells, numRedundancy, cutoff, bandWidth],
                (err) => {
                if (err) {
