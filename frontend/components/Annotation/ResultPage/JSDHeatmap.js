...
export default function JSDHeatmap(props) {
    // use echarts
    ...
    function renderChart() {
        try {
            ...
            let option =
                {
                    title:{
                        text:"JS Divergence of cell types colocalization",
                        textStyle:{
                            fontSize:14
                        }
                    },
    ...
    return(
        <div ref={chartRef} style={{height:400,width:400,marginBottom:10}}></div>
    )
}
